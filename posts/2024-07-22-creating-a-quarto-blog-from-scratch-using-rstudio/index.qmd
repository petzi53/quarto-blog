...
![Image by Mine Çetinkaya-Rundel from [Get Started with Quarto](https://quarto.org/docs/blog/posts/2023-05-15-get-started) - A video
...
scratch.](creating-quarto-blog-1-min.png){#fig-new-project-wizard group="initialize-blog"
...
initialize a blog
project](creating-quarto-blog-2-min.png){#fig-new-blog-project-window group="initialize-blog"
...
data](creating-quarto-blog-3-min.png){#fig-create-blog-window group="initialize-blog"
...
scratch.](generated-files-at-start-min.png){#fig-rstudio-file-listing-window group="initialize-blog"
...
window
(Screenshot)](click-render-button-first-time-min.png){#fig-source-code-blog-home-page group="initialize-blog"
...
(Screenshot):](rendered-blog-first-time-min.png){#fig-blog-listing-start-page group="initialize-blog"
