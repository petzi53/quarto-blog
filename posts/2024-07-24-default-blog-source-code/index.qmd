...
![First rendering after initializing a Quarto blog (Screenshot)](virgin-blog-homepage-min.png){#fig-fist-rendering group="blog-source"
...
![Screenshot of the blog’s homepage after changing the blog listing title in `index.qmd`](blog-title-changed-min.png){#fig-blog-title-changed group="blog-source"
...
![Screenshot of the blog’s homepage after changing the title of the website in `_quarto.yml`](website-title-changed-min.png){#fig-website-title-changed group="blog-source"
...
![Content of the `posts` folder immediately after the initialization process](content-of-posts-directory-min.png){#fig-content-posts-folder group="blog-source"
...
![Dummy articles after the blog initialiation in grid listing mode (Screenshot)](grid-listing-min.png){#fig-grid-listing group="blog-source"
...
![Dummy articles after the blog initialiation in table listing mode](table-listing-min.png){#fig-table-listing group="blog-source"
...
![Dummy articles after the blog initialiation in default listing mode (Screenshot)](default-listing-min.png){#fig-default-listing group="blog-source"
...
![Blog homepage without banner for the title block (Screenshot)](no-title-block-banner-min.png){#fig-no-blog-banner group="blog-source" 
...
![List of changed files expalined in this blog post (Screenshot)](changed-files-min.png){#fig-changed-files group="blog-source"
...
![Changes in the about.qmd file (Screenshot)](content-of-changes-in-about-min.png){#fig-commit-about-changes group="blog-source"
...
![Updated GitHub repo after second commit (Screenshot)](github-second-commit-2-min.png){#fig-github-second-commit group="blog-source"
